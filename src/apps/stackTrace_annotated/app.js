...
var all_hashes = []; 
all_hashes = karousos.recordAccess(all_hashes, requestID, handlerID, false, true);
...
in_progress = karousos.recordAccess(in_progress, requestID, handlerID, false, true);
