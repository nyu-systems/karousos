...
module.exports = {
  ...
  init() {
    let self = this
    //karousos.recordAccess(self, requestID, handlerID, false, true);

    // Fetch DB Config

    let dbClient = null
    karousos.recordAccess(dbClient, requestID, handlerID, false, true);
    ...
    karousos.recordAccess(dbConfig, requestID, handlerID, false, true);
    karousos.recordAccess(dbConfig.host, requestID, handlerID, false, true,dbConfig,"host");
    karousos.recordAccess(dbConfig.user, requestID, handlerID, false, true,dbConfig,"user");
    karousos.recordAccess(dbConfig.password, requestID, handlerID, false, true,dbConfig,"password");
    karousos.recordAccess(dbConfig.database, requestID, handlerID, false, true, dbConfig,"database");
    karousos.recordAccess(dbConfig.port, requestID, handlerID, false, true,dbConfig,"port");
    ...
    karousos.recordAccess(dbUseSSL, requestID, handlerID, false, true);

    let sslOptions = null
    karousos.recordAccess(sslOptions, requestID, handlerID, false, true);
    ...
    karousos.recordAccess(this.knex, requestID, handlerID, false, true,this,"knex");
    karousos.recordAccess(this.knex.client, requestID, handlerID, false, true);
  ...
  trxClient.logger = clie*/
   // karousos.recordAccess(this.knex.client.config.useNullAsDefault, requestID, handlerID, false, true);
/*
    karousos.recordAccess(this.knex.client.config.client, requestID, handlerID, false, true);
    karousos.recordAccess(this.knex.client.config.client, requestID, handlerID, false, true);
    karousos.recordAccess(this.knex.client.config.client, requestID, handlerID, false, true);
    karousos.recordAccess(this.knex.client.config.client, requestID, handlerID, false, true);
    karousos.recordAccess(this.knex.client.config.client, requestID, handlerID, false, true);
    ...
    //karousos.recordAccess(this.knex.client.connectionSettings, requestID, handlerID, false, true);
    //karousos.recordAccess(this.knex.client.config, requestID, handlerID, false, true);

      //this.knex.client,"connectionSettings");

    //karousos.recordAccess(this.knex.client.connectionSettings.host, requestID, handlerID, false, true,this.knex.client.connectionSettings,"host");
    //karousos.recordAccess(this.knex.client.connectionSettings.user, requestID, handlerID, false, true,this.knex.client.connectionSettings,"user");
    //karousos.recordAccess(this.knex.client.connectionSettings.database, requestID, handlerID, false, true,this.knex.client.connectionSettings,"database");
    //karousos.recordAccess(this.knex.client.connectionSettings.port, requestID, handlerID, false, true,this.knex.client.connectionSettings,"port");
    //karousos.recordAccess(this.knex.client.connectionSettings.password, requestID, handlerID, false, true,this.knex.client.connectionSettings,"password");
    //karousos.recordAccess(this.knex.client.connectionSettings.typeCast, requestID, handlerID, false, true,this.knex.client.connectionSettings,"typeCast");

    karousos.recordAccess(this.knex.client.log, requestID, handlerID, false, true);

    karousos.recordAccess(this.knex.debug, requestID, handlerID, false, true,this.knex,"debug");
    karousos.recordAccess(this.knex.connection, requestID, handlerID, false, true,this.knex,"connection");
    karousos.recordAccess(this.knex.useNullAsDefault, requestID, handlerID, false, true,this.knex,"useNullAsDefault");
    karousos.recordAccess(this.knex.asyncStackTraces, requestID, handlerID, false, true,this.knex,"asyncStackTraces");


    Objection.Model.knex(this.knex)
    // Load DB Models

    const models = autoload(path.join(WIKI.SERVERPATH, 'modells'))
    karousos.recordAccess(models, requestID, handlerID, false, true);

    // Set init tasks
    let conAttempts = 0
    karousos.recordAccess(conAttempts, requestID, handlerID, false, true);
    ...
    //karousos.recordAccess(initTasks, requestID, handlerID, false, true);
    //karousos.recordAccess(initTasks.connect, requestID, handlerID, false, true,initTasks,"connect");
    //karousos.recordAccess(initTasks.syncSchemas, requestID, handlerID, false, true,initTasks,"syncSchemas");
    //karousos.recordAccess(initTasks.migrateFromBeta, requestID, handlerID, false, true,initTasks,"migrateFromBeta");
   ...
   // karousos.recordAccess(initTasksQueue, requestID, handlerID, false, true);
