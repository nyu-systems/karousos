...
class Job {
  constructor({
    ...
    this.name = name
    //karousos.recordAccess(this.name, requestID, handlerID, false, true, this, "name");
    this.immediate = immediate
    //karousos.recordAccess(this.nameimmediate, requestID, handlerID, false, true, this, "immediate");
    this.schedule = moment.duration(schedule)
    //karousos.recordAccess(this.schedule, requestID, handlerID, false, true, this, "schedule");
    this.repeat = repeat
    //karousos.recordAccess(this.repeat, requestID, handlerID, false, true, this, "repeat");
    this.worker = worker
    //karousos.recordAccess(this.worker, requestID, handlerID, false, true, this, "worker");
  }
...
const jobs = [];
karousos.recordAccess(jobs, requestID, handlerID, false, true);
