...
set output '../plots/advice_size_message_w.pdf'
set datafile separator comma

#key
set key nobox outside bottom Left reverse horizontal 

set ylabel "Advice size (MB)"  offset 1.5,0 
set xlabel "# Concurrent Requests"

plot '../csv_files_advice/message_w.csv' using 3:xticlabels(1) title "Orochi-JS" ls 3, \
	'../csv_files_advice/message_w.csv' using 2:xticlabels(1) title "Karousos" ls 2 \
