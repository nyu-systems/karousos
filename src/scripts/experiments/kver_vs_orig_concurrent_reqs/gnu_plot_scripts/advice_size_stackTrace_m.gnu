...
set output '../plots/advice_size_stackTrace_m.pdf'
...
plot '../csv_files_advice/stackTrace_m.csv' using 3:xticlabels(1) title "Orochi-JS" ls 3, \
	'../csv_files_advice/stackTrace_m.csv' using 2:xticlabels(1) title "Karousos" ls 2
