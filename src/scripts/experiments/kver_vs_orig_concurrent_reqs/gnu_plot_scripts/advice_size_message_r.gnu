...
set output '../plots/advice_size_message_r.pdf'
...
plot '../csv_files_advice/message_r.csv' using 3:xticlabels(1) title "Orochi-JS" ls 3, \
   '../csv_files_advice/message_r.csv' using 2:xticlabels(1) title "Karousos" ls 2 \
