...
set output '../plots/kver_vs_baseline_stackTrace_w.pdf'
...
plot '../csv_files_ver/stackTrace_w.csv' using 2:3:4:xticlabels(1) title "Baseline" ls 1, \
  '../csv_files_ver/stackTrace_w.csv' using 8:9:10:xticlabels(1) title "Orochi-JS" ls 3, \
  '../csv_files_ver/stackTrace_w.csv' using 5:6:7:xticlabels(1) title "Karousos" ls 2
