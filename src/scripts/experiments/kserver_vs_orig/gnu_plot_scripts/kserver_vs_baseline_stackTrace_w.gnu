...
set output '../plots/kserver_vs_baseline_stackTrace_w.pdf'
...
plot '../csv_files/stackTrace_w.csv' using 2:3:4:xticlabels(1) title "Unmodified" ls 1, \
   '../csv_files/stackTrace_w.csv' using 5:6:7:xticlabels(1) title "Karousos" ls 2
