...
set output '../plots/kserver_vs_baseline_stackTrace_r.pdf'
...
set ylabel "Server Execution time (s)"  
set xlabel "# Concurrent Requests"

plot '../csv_files/stackTrace_r.csv' using 2:3:4:xticlabels(1) title "Unmodified" ls 1, \
   '../csv_files/stackTrace_r.csv' using 5:6:7:xticlabels(1) title "Karousos" ls 2
